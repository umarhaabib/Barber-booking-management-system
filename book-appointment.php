...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
        $adminEmailQuery = " SELECT Email FROM tbladmin ";
        $adminEmailResult = mysqli_query($con, $adminEmailQuery);
        $adminEmail = mysqli_fetch_array($adminEmailResult);
        $adminEmail = $adminEmail['Email'];

        sendNewAppointmentEmail($aptnumber, $adate, $atime, $msg);
        sendEmailToAdmin($aptnumber, $adate, $atime, $msg,$adminEmail);
...
<html lang="en">
  <head>
    ...
    <title>Barber Booking System | Appointment Page</title>
...
<section class="w3l-contact-info-main" id="contact">
    <div class="contact-sec	">
        ...
        <?php $query1=mysqli_query($con,"Select * from tblbook where Status='Accepted'");
                         ...
                         {
                         	?>
                         	<h3 style="color:red">All slots are booked for today. Please try again tomorrow.</h3>
                         	<?php
                         }
                         else
                         {
        ...
        <a href="#" class="badge badge-primary" style="width: 25%;float: right;"> <strong>Available slots : </strong><?php echo $availableslots; ?></a>
            <div class="d-grid contact-view">
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-contact" name="submit">Book an Appointment</button>
                    </form>
                </div>
