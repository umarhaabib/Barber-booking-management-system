...
<html lang="en">
  <head>
    ...
    <title>Barber Booking System | Home Page</title>
...
<div class="w3l-hero-headers-9">
  <div class="css-slider">
    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="">
          <h4>Innovative fashion</h4>
          <h3>beauty salon one click away<br>
            fashion for all</h3>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">The most popular salon is ours.</h4>
                            <p class="para ">Beauty Services Offered by Barber Hair and Beauty Salon</p>
	...
	<div class="team-single-main ">
		<div class="container">
				...
				<div class="column2 image-text">
					<h3 class="team-head ">Visit us to discover the secrets of relaxation.</h3>
					<p class="para  text ">
          The best beauty expert comes to your house and offers in-home beauty services. Home Salon offers a variety of beauty services including facials, clean-up, bleaching, waxing, pedicures, manicures, and more.</p>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-6 back-image">
                    <img src="assets/images/t5.jpg" alt="product" class="img-responsive ">
                </div>
                <div class="col-lg-6 about-right-faq align-self">
                    <h3 class="title-big"><a href="about.html">Recommended hair salon</a></h3>
                    <p class="mt-3 para"> Cuts, hair spas, colouring, texturing, styling, waxing, pedicures, manicures, threading, body spa, natural facials, and more are all part of their extensive menu of beauty salon services.</p>
                        <div class="hair-cut">
                            <div >
