...
<html lang="en">
  <head>
    ...
    <title>Barber Booking System | Booking History</title>
...
?>              
                    ...
                    <div id="invoice-table" class="table-responsive bs-example widget-shadow">
...
<th><?php echo $gtotal?></th>   
  ...
  <i class="fa fa-print fa-2x" style="cursor: pointer;"  onclick="printInvoice(this)" ></i>
</p>
                    </div> </div>
...
<script>
  ...
  function printInvoice(strid) {
        var prtContent = document.getElementById("invoice-table");
