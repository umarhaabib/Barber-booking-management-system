...
<html lang="en">
  <head>
    ...
    <title>Barber Booking System | service Page </title>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 <img src="admin/images/<?php echo $row['Image']?>" alt="product" height="200" width="400" class="img-responsive about-me">
                    <div class="about-grids ">
                        <hr>
                        <a href="book-appointment.php" class="badge badge-primary" style="width: 100%;">Book appointment</a>

                        <div style="display: flex;">
                        <h5 class="para" style="width: 100%;"><?php  echo $row['ServiceName'];?></h5>
                        </div
