...
<html>
<head>
<title> Barber || View Invoice</title>
...
?>				
					...
					<div id="table-invoice" class="table-responsive bs-example widget-shadow">
...
function PrintInvoice(strid) {
     var prtContent = document.getElementById("table-invoice");
